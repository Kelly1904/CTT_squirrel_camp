...
detection_blu <- subset.data.frame(detection_blu, 
                                  tag_id == my_tag_id)
...
mapshot(calibration_map, 
        file = "results/calibration_map_blu.png")
...
rssi_v_dist <- calc_rssi_v_dist(node_locs = node_locs, 
                                ...
                                use_sync = TRUE) #For Blu Series tags use_sync=TRUE, for 434 MHz tags use_sync=FALSE.
